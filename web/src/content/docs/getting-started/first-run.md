...
```bash
skillx run https://github.com/skillx-run/skillx.run/tree/main/examples/skills/name-poem "你的名字"
```
...
```bash
skillx run --no-cache github:skillx-run/skillx.run/examples/skills/name-poem "你的名字"
```

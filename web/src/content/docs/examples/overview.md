...
Official Examples live in this repository and are designed to teach skill structure, patterns, and file layouts you can reuse. Famous Skills are different: they are curated external GitHub skills that you can run directly when you want a ready-made workflow from an upstream source.

## Official Example Entrypoints

| Example | What it covers |
|---------|----------------|
| [Code Review](/examples/code-review/) | Structured review output with severity levels and actionable feedback |
| [Commit Message](/examples/commit-message/) | Conventional commit generation from staged changes |
